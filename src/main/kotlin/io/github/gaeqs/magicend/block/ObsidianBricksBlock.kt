...
class ObsidianBricksBlock : Block(FabricBlockSettings.of(Material.STONE).strength(2.0f)) {


    companion object {
        val IDENTIFIER = Identifier(MinecraftMod.MOD_ID, "obsidian_bricks")
        val BLOCK = ObsidianBricksBlock()
