...
class EndFenceCornerBlock : Block(FabricBlockSettings.of(Material.METAL).strength(2.0f)) {

    companion object {
        val FACING: DirectionProperty = HorizontalFacingBlock.FACING
        val IDENTIFIER = Identifier(MinecraftMod.MOD_ID, "end_fence_corner")
        val BLOCK = EndFenceCornerBlock()
